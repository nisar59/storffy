 ...
 <!-- Content Wrapper. Contains page content -->
  ...
  <div class="container">
    <div class="card card-primary">
              ...
              <form method="POST" action="{{url('coupons_for/update/' . $data->id)}}">
                @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Name</label>
                    <input type="text" class="form-control" name="name" value="{{$data->name}}" id="exampleInputEmail1" placeholder="Enter Name">
                  </div>
